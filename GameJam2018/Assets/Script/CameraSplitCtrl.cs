...
public class CameraSplitCtrl : MonoBehaviour
{
	...
	public Image recImg1_1;
	public Image recImg2_1;
	public Image recImg2_2;
	public Image recImg4_1;
	public Image recImg4_2;
	public Image recImg4_3;
	public Image recImg4_4;
	public Image recImg8_1;
	public Image recImg8_2;
	public Image recImg8_3;
	public Image recImg8_4;
	public Image recImg8_5;
	public Image recImg8_6;
	public Image recImg8_7;
	public Image recImg8_8;
	public Image recImg16_1;
	public Image recImg16_2;
	public Image recImg16_3;
	public Image recImg16_4;
	public Image recImg16_5;
	public Image recImg16_6;
	public Image recImg16_7;
	public Image recImg16_8;
	public Image recImg16_9;
	public Image recImg16_10;
	public Image recImg16_11;
	public Image recImg16_12;
	public Image recImg16_13;
	public Image recImg16_14;
	public Image recImg16_15;
	public Image recImg16_16;
	...
	void initWidthAndHeights(){
		...
		image1_1.rectTransform.sizeDelta = new Vector2 (totalWidth-Screen.width/8, totalHeight-Screen.height/4.5f);
		recImg1_1.rectTransform.sizeDelta = new Vector2 (totalWidth, totalHeight);

		image2_1.rectTransform.sizeDelta = new Vector2 (totalWidth / 2f-Screen.width/16, totalHeight / 2f-Screen.height/9f);
		image2_1.rectTransform.localPosition = new Vector3 (-totalWidth / 4f, 0f, 0f);
		image2_2.rectTransform.sizeDelta = new Vector2 (totalWidth / 2f-Screen.width/16, totalHeight / 2f-Screen.height/9f);
		image2_2.rectTransform.localPosition = new Vector3 (totalWidth / 4f, 0f, 0f);
		recImg2_1.rectTransform.sizeDelta = new Vector2 (totalWidth / 2f, totalHeight / 2f);
		recImg2_1.rectTransform.localPosition = new Vector3 (-totalWidth / 4f, 0f, 0f);
		recImg2_2.rectTransform.sizeDelta = new Vector2 (totalWidth / 2f, totalHeight / 2f);
		recImg2_2.rectTransform.localPosition = new Vector3 (totalWidth / 4f, 0f, 0f);

		image4_1.rectTransform.sizeDelta = new Vector2 (totalWidth / 2f-Screen.width/16, totalHeight / 2f-Screen.height/9f);
		image4_1.rectTransform.localPosition = new Vector3 (-totalWidth / 4f, totalHeight/4f, 0f);
		image4_2.rectTransform.sizeDelta = new Vector2 (totalWidth / 2f-Screen.width/16, totalHeight / 2f-Screen.height/9f);
		image4_2.rectTransform.localPosition = new Vector3 (totalWidth / 4f, totalHeight/4f, 0f);
		image4_3.rectTransform.sizeDelta = new Vector2 (totalWidth / 2f-Screen.width/16, totalHeight / 2f-Screen.height/9f);
		image4_3.rectTransform.localPosition = new Vector3 (-totalWidth / 4f, -totalHeight/4f, 0f);
		image4_4.rectTransform.sizeDelta = new Vector2 (totalWidth / 2f-Screen.width/16, totalHeight / 2f-Screen.height/9f);
		image4_4.rectTransform.localPosition = new Vector3 (totalWidth / 4f, -totalHeight/4f, 0f);
		recImg4_1.rectTransform.sizeDelta = new Vector2 (totalWidth / 2f, totalHeight / 2f);
		recImg4_1.rectTransform.localPosition = new Vector3 (-totalWidth / 4f, totalHeight/4f, 0f);
		recImg4_2.rectTransform.sizeDelta = new Vector2 (totalWidth / 2f, totalHeight / 2f);
		recImg4_2.rectTransform.localPosition = new Vector3 (totalWidth / 4f, totalHeight/4f, 0f);
		recImg4_3.rectTransform.sizeDelta = new Vector2 (totalWidth / 2f, totalHeight / 2f);
		recImg4_3.rectTransform.localPosition = new Vector3 (-totalWidth / 4f, -totalHeight/4f, 0f);
		recImg4_4.rectTransform.sizeDelta = new Vector2 (totalWidth / 2f, totalHeight / 2f);
		recImg4_4.rectTransform.localPosition = new Vector3 (totalWidth / 4f, -totalHeight/4f, 0f);

		image8_1.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f-Screen.width/32, totalHeight / 4f-Screen.height/18);
		image8_1.rectTransform.localPosition = new Vector3 (-totalWidth / 8f * 3f, totalHeight/8f, 0f);
		image8_2.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f-Screen.width/32, totalHeight / 4f-Screen.height/18);
		image8_2.rectTransform.localPosition = new Vector3 (-totalWidth / 8f, totalHeight/8f, 0f);
		image8_3.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f-Screen.width/32, totalHeight / 4f-Screen.height/18);
		image8_3.rectTransform.localPosition = new Vector3 (totalWidth / 8f, totalHeight/8f, 0f);
		image8_4.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f-Screen.width/32, totalHeight / 4f-Screen.height/18);
		image8_4.rectTransform.localPosition = new Vector3 (totalWidth / 8f * 3f, totalHeight/8f, 0f);
		image8_5.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f-Screen.width/32, totalHeight / 4f-Screen.height/18);
		image8_5.rectTransform.localPosition = new Vector3 (-totalWidth / 8f * 3f, -totalHeight/8f, 0f);
		image8_6.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f-Screen.width/32, totalHeight / 4f-Screen.height/18);
		image8_6.rectTransform.localPosition = new Vector3 (-totalWidth / 8f, -totalHeight/8f, 0f);
		image8_7.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f-Screen.width/32, totalHeight / 4f-Screen.height/18);
		image8_7.rectTransform.localPosition = new Vector3 (totalWidth / 8f, -totalHeight/8f, 0f);
		image8_8.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f-Screen.width/32, totalHeight / 4f-Screen.height/18);
		image8_8.rectTransform.localPosition = new Vector3 (totalWidth / 8f * 3f, -totalHeight/8f, 0f);
		recImg8_1.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f, totalHeight / 4f);
		recImg8_1.rectTransform.localPosition = new Vector3 (-totalWidth / 8f * 3f, totalHeight/8f, 0f);
		recImg8_2.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f, totalHeight / 4f);
		recImg8_2.rectTransform.localPosition = new Vector3 (-totalWidth / 8f, totalHeight/8f, 0f);
		recImg8_3.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f, totalHeight / 4f);
		recImg8_3.rectTransform.localPosition = new Vector3 (totalWidth / 8f, totalHeight/8f, 0f);
		recImg8_4.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f, totalHeight / 4f);
		recImg8_4.rectTransform.localPosition = new Vector3 (totalWidth / 8f * 3f, totalHeight/8f, 0f);
		recImg8_5.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f, totalHeight / 4f);
		recImg8_5.rectTransform.localPosition = new Vector3 (-totalWidth / 8f * 3f, -totalHeight/8f, 0f);
		recImg8_6.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f, totalHeight / 4f);
		recImg8_6.rectTransform.localPosition = new Vector3 (-totalWidth / 8f, -totalHeight/8f, 0f);
		recImg8_7.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f, totalHeight / 4f);
		recImg8_7.rectTransform.localPosition = new Vector3 (totalWidth / 8f, -totalHeight/8f, 0f);
		recImg8_8.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f, totalHeight / 4f);
		recImg8_8.rectTransform.localPosition = new Vector3 (totalWidth / 8f * 3f, -totalHeight/8f, 0f);

		image16_1.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f-Screen.width/32, totalHeight / 4f-Screen.height/18);
		image16_1.rectTransform.localPosition = new Vector3 (-totalWidth / 8f * 3f, totalHeight/8f * 3f, 0f);
		image16_2.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f-Screen.width/32, totalHeight / 4f-Screen.height/18);
		image16_2.rectTransform.localPosition = new Vector3 (-totalWidth / 8f, totalHeight/8f * 3f, 0f);
		image16_3.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f-Screen.width/128, totalHeight / 4f-Screen.height/18);
		image16_3.rectTransform.localPosition = new Vector3 (totalWidth / 8f, totalHeight/8f * 3f, 0f);
		image16_4.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f-Screen.width/32, totalHeight / 4f-Screen.height/18);
		image16_4.rectTransform.localPosition = new Vector3 (totalWidth / 8f * 3f, totalHeight/8f * 3f, 0f);
		image16_5.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f-Screen.width/32, totalHeight / 4f-Screen.height/18);
		image16_5.rectTransform.localPosition = new Vector3 (-totalWidth / 8f * 3f, totalHeight/8f, 0f);
		image16_6.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f-Screen.width/32, totalHeight / 4f-Screen.height/18);
		image16_6.rectTransform.localPosition = new Vector3 (-totalWidth / 8f, totalHeight/8f, 0f);
		image16_7.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f-Screen.width/32, totalHeight / 4f-Screen.height/18);
		image16_7.rectTransform.localPosition = new Vector3 (totalWidth / 8f, totalHeight/8f, 0f);
		image16_8.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f-Screen.width/32, totalHeight / 4f-Screen.height/18);
		image16_8.rectTransform.localPosition = new Vector3 (totalWidth / 8f * 3f, totalHeight/8f, 0f);
		image16_9.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f-Screen.width/32, totalHeight / 4f-Screen.height/18);
		image16_9.rectTransform.localPosition = new Vector3 (-totalWidth / 8f * 3f, -totalHeight/8f, 0f);
		image16_10.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f-Screen.width/32, totalHeight / 4f-Screen.height/18);
		image16_10.rectTransform.localPosition = new Vector3 (-totalWidth / 8f, -totalHeight/8f, 0f);
		image16_11.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f-Screen.width/32, totalHeight / 4f-Screen.height/18);
		image16_11.rectTransform.localPosition = new Vector3 (totalWidth / 8f, -totalHeight/8f, 0f);
		image16_12.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f-Screen.width/32, totalHeight / 4f-Screen.height/18);
		image16_12.rectTransform.localPosition = new Vector3 (totalWidth / 8f * 3f, -totalHeight/8f, 0f);
		image16_13.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f-Screen.width/32, totalHeight / 4f-Screen.height/18);
		image16_13.rectTransform.localPosition = new Vector3 (-totalWidth / 8f * 3f, -totalHeight/8f * 3f, 0f);
		image16_14.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f-Screen.width/32, totalHeight / 4f-Screen.height/18);
		image16_14.rectTransform.localPosition = new Vector3 (-totalWidth / 8f, -totalHeight/8f * 3f, 0f);
		image16_15.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f-Screen.width/32, totalHeight / 4f-Screen.height/18);
		image16_15.rectTransform.localPosition = new Vector3 (totalWidth / 8f, -totalHeight/8f * 3f, 0f);
		image16_16.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f-Screen.width/32, totalHeight / 4f-Screen.height/18);
		image16_16.rectTransform.localPosition = new Vector3 (totalWidth / 8f * 3f, -totalHeight/8f * 3f, 0f);
		recImg16_1.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f, totalHeight / 4f);
		recImg16_1.rectTransform.localPosition = new Vector3 (-totalWidth / 8f * 3f, totalHeight/8f * 3f, 0f);
		recImg16_2.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f, totalHeight / 4f);
		recImg16_2.rectTransform.localPosition = new Vector3 (-totalWidth / 8f, totalHeight/8f * 3f, 0f);
		recImg16_3.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f, totalHeight / 4f);
		recImg16_3.rectTransform.localPosition = new Vector3 (totalWidth / 8f, totalHeight/8f * 3f, 0f);
		recImg16_4.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f, totalHeight / 4f);
		recImg16_4.rectTransform.localPosition = new Vector3 (totalWidth / 8f * 3f, totalHeight/8f * 3f, 0f);
		recImg16_5.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f, totalHeight / 4f);
		recImg16_5.rectTransform.localPosition = new Vector3 (-totalWidth / 8f * 3f, totalHeight/8f, 0f);
		recImg16_6.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f, totalHeight / 4f);
		recImg16_6.rectTransform.localPosition = new Vector3 (-totalWidth / 8f, totalHeight/8f, 0f);
		recImg16_7.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f, totalHeight / 4f);
		recImg16_7.rectTransform.localPosition = new Vector3 (totalWidth / 8f, totalHeight/8f, 0f);
		recImg16_8.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f, totalHeight / 4f);
		recImg16_8.rectTransform.localPosition = new Vector3 (totalWidth / 8f * 3f, totalHeight/8f, 0f);
		recImg16_9.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f, totalHeight / 4f);
		recImg16_9.rectTransform.localPosition = new Vector3 (-totalWidth / 8f * 3f, -totalHeight/8f, 0f);
		recImg16_10.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f, totalHeight / 4f);
		recImg16_10.rectTransform.localPosition = new Vector3 (-totalWidth / 8f, -totalHeight/8f, 0f);
		recImg16_11.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f, totalHeight / 4f);
		recImg16_11.rectTransform.localPosition = new Vector3 (totalWidth / 8f, -totalHeight/8f, 0f);
		recImg16_12.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f, totalHeight / 4f);
		recImg16_12.rectTransform.localPosition = new Vector3 (totalWidth / 8f * 3f, -totalHeight/8f, 0f);
		recImg16_13.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f, totalHeight / 4f);
		recImg16_13.rectTransform.localPosition = new Vector3 (-totalWidth / 8f * 3f, -totalHeight/8f * 3f, 0f);
		recImg16_14.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f, totalHeight / 4f);
		recImg16_14.rectTransform.localPosition = new Vector3 (-totalWidth / 8f, -totalHeight/8f * 3f, 0f);
		recImg16_15.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f, totalHeight / 4f);
		recImg16_15.rectTransform.localPosition = new Vector3 (totalWidth / 8f, -totalHeight/8f * 3f, 0f);
		recImg16_16.rectTransform.sizeDelta = new Vector2 (totalWidth / 4f, totalHeight / 4f);
		recImg16_16.rectTransform.localPosition = new Vector3 (totalWidth / 8f * 3f, -totalHeight/8f * 3f, 0f);
	}
